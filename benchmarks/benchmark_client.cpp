// Dedicated latency benchmarking suite.
// 4 scenarios: sequential RTT, throughput, warm-up analysis, message size impact.
...
// Send-receive one at a time, measure true per-message RTT
...
// Burst-send all messages then drain — measures raw throughput
...
// Compare cold-start latency vs. warm (cache/branch predictor warmed up)
...
// Vary payload size to see how message length affects RTT
